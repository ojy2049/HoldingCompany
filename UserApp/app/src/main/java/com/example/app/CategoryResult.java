...
public class CategoryResult implements Parcelable {
    ...
    @Expose
    private List<KaKao> documents = null;
    ...
    public List<KaKao> getDocuments() {
        return documents;
    }

    public void setDocuments(List<KaKao> documents) {
    ...
    protected CategoryResult(Parcel in) {
        ...
        this.documents = new ArrayList<KaKao>();
        in.readList(this.documents, KaKao.class.getClassLoader());
    }
